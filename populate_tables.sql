...
Values
    ('500000123','ABC00001','999','Letsby Avenue',null ,'Metropolis','Metro','India', 'MP01 11AB', '1982-09-17', true, 'Officer Dibble', null,false,'Active',
                '01336 216999', 'Police Academy', 'This is some comments about the business', 200301,200701, '01336 216999'),
    ('500000456','ABC00002','18','Slingsby Road',null,'Pontypool','Gwent','Wales','NP4 6AD','1999-01-01', true, 'King Mike', '2019-03-20', true,'De-active',
                '01662 123989', 'Alice Cooper', 'This is me making some random comments', 200302,200702, '01662 123987'),
    ('500000789','ABC00003','22','Avenue Road','stallards','Trowbridge','Wiltshire','England','BA22 1ST', '1997-02-24',false, 'Lord Luke', null, true,'Active',
                '07462 456239', 'Bon Scott', 'Im on a highway to hell', 200303,200703, '03647 345987'),
    ('500000321','ABC00004','88','Gurner Terrice',null,'Melksham','aha','Sudan', 'SW4 6LP', '1994-08-21',false, 'Duke David', null, true,'Active',
                '01234 654321', 'Jimmi Page', 'Its been a long time since I Rock and Roll', 200304,200704, '01422 456757'),
    ('500000876','ABC00005','4','Pete Place', 'peaty', 'Petersfield','Hants','England', 'GU32 1RT', '2001-11-3', true, 'Baron Binay', null,false,'Active',
...
Values
    ('001','999','Letsby Avenue',null ,'Metropolis','Metro','India', 'MP01 11AB','Tied up','dibble@topcat.com','01179 087654',
                'Officer Dibble', 'This one','doesnt like to be called between 1 and 12','01179 087655'),
    ('002','18','Slingsby Road',null,'Pontypool','Gwent','Wales','NP4 6AD','Locked up','king@mike.com','01234 045658',
    ...
    ('004','88','Gurner Terrice',null,'Melksham','aha','Sudan', 'SW4 6LP','available','duke@david.com','07658 823671',
...
values
    ('Q0000001','Results Processing','ABC00001','ZYX0000000000000000012345','201701','201810',1,'2019-03-30',true,'Construction','2019-04-10',true,
        'I dont like this table','open','JLS','incomplete','2019-09-01'),
    ('Q0000002','Results Processing','ABC00001','ZYX0000000000000000012345','201701','201906',1,'2019-03-30',true,'Construction','2019-04-10',false,
        'time for bed said zebedee','open','AHD','incomplete','2019-10-02'),
    ('Q0000003','Results Processing','ABC00002','ZYX0000000000000000023451','201801','201912',1,'2019-02-28',false,'Construction','2019-04-10',true,
        'dirty deeds done dirt cheap','open','LSD','incomplete','2019-09-03'),
    ('Q0000004','Results Processing','ABC00003','ZYX0000000000000000034512','201803','201711',1,'2019-08-30',false,'Construction','2016-04-10',true,
        'Im singing in the rain','open','JLS','complete','2019-09-10'),
    ('Q0000005','Results Processing','ABC00003','ZYX0000000000000000034512','201803','201809',1,'2019-03-30',true,'Construction','2018-02-22',false,
...
values
    ('Q0000001','201701',1,'ABC00001','Cleaning','ZYX0000000000000000012345','err00145','The data is unclean'),
    ('Q0000002','201701',1,'ABC00001','Smelling','ZYX0000000000000000012345','err28476','The data smells bad'),
    ('Q0000003','201801',1,'ABC00002','Inventing','ZYX0000000000000000023451','err3958','The data should be made up'),
    ('Q0000004','201803',1,'ABC00003','discovering','ZYX0000000000000000034512','err00045','Cant find the data'),
    ('Q0000005','201803',1,'ABC00003','loitering','ZYX0000000000000000034512','err00467','The data seems to be hanging around');
...
values
    ('201701',1,1,'ABC00001','Cleaning','ZYX0000000000000000012345','Was told this data was filthy'),
    ('201701',2,1,'ABC00001','Smelling','ZYX0000000000000000012345','Was told this data smells'),
    ('201801',3,1,'ABC00002','Inventing','ZYX0000000000000000023451','Told the contributor had lied'),
    ('201803',4,1,'ABC00003','discovering','ZYX0000000000000000034512','Was told the data is missing'),
    ('201803',5,1,'ABC00003','loitering','ZYX0000000000000000034512','Was told this data wont go away');
...
values
    (123,'201701',1,1,'ABC00001','Cleaning','ZYX0000000000000000012345'),
    (115,'201701',2,1,'ABC00001','Smelling','ZYX0000000000000000012345'),
    (189,'201801',3,1,'ABC00002','Inventing','ZYX0000000000000000023451'),
    (193,'201803',4,1,'ABC00003','discovering','ZYX0000000000000000034512'),
    (123,'201803',5,1,'ABC00003','loitering','ZYX0000000000000000034512');
